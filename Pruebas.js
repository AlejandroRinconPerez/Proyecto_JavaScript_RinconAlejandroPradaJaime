...
function FiltroRangoGeneralPartiendode__0(data, llave1, llave2, Rango1 ) {
 ...
 const botonComprar30 = document.querySelector('#mayor70');
botonComprar30.addEventListener('click', function() {
    obtener_multiplesRango(url, FiltroRangoGeneralPartiendode__0, "name", "height",  10, 70)
});
const botonComprar31 = document.querySelector('#mayor90');
botonComprar31.addEventListener('click', function() {
    obtener_multiplesRango(url, FiltroRangoGeneralPartiendode__0, "name", "height",  10, 90)
});

const botonComprar32 = document.querySelector('#mayor120');
botonComprar32.addEventListener('click', function() {
    obtener_multiplesRango(url, FiltroRangoGeneralPartiendode__0, "name", "height",  10, 120)
});
const botonMayor33 = document.querySelector('#mayor180');
botonMayor33.addEventListener('click', function() {
    obtener_multiplesRango(url, FiltroRangoGeneralPartiendode__0, "name", "height", 10, 180);
});
...
const botonMayor35 = document.querySelector('#mayor220');
botonMayor35.addEventListener('click', function() {
    obtener_multiplesRango(url, FiltroRangoGeneralPartiendode__0, "name", "height", 10, 220);
});
...
const botonComprar37 = document.querySelector('#Cargocapacity10000');
botonComprar37.addEventListener('click', function() {
    obtener_multiplesRango(url3, FiltroRangoGeneralPartiendodevehicles, "name", "cargo_capacity", 5, 10000);
});
...
const botonComprar41 = document.querySelector('#cost_in_credits5000');
botonComprar41.addEventListener('click', function() {
    obtener_multiplesRango(url3, FiltroRangoGeneralPartiendodevehicles, "name", "cost_in_credits", 5, 5000);
});

const botonComprar42 = document.querySelector('#cost_in_credits10000');
botonComprar42.addEventListener('click', function() {
    obtener_multiplesRango(url3, FiltroRangoGeneralPartiendodevehicles, "name", "cost_in_credits", 5, 10000);
});
...
const botonComprar44 = document.querySelector('#cost_in_credits30000');
botonComprar44.addEventListener('click', function() {
    obtener_multiplesRango(url3, FiltroRangoGeneralPartiendodevehicles, "name", "cost_in_credits", 5, 30000);
});
...
const botonComprar46 = document.querySelector('#length_1');
botonComprar46.addEventListener('click', function() {
    obtener_multiplesRango(url3, FiltroRangoGeneralPartiendodevehicles, "name", "length", 5, 1);
});

const botonComprar47 = document.querySelector('#length_5');
botonComprar47.addEventListener('click', function() {
    obtener_multiplesRango(url3, FiltroRangoGeneralPartiendodevehicles, "name", "length", 5, 5);
});

const botonComprar48 = document.querySelector('#length_6');
botonComprar48.addEventListener('click', function() {
    obtener_multiplesRango(url3, FiltroRangoGeneralPartiendodevehicles, "name", "length", 5, 6);
});

const botonComprar49 = document.querySelector('#length_7');
botonComprar49.addEventListener('click', function() {
    obtener_multiplesRango(url3, FiltroRangoGeneralPartiendodevehicles, "name", "length", 5, 7);
});

const botonComprar50 = document.querySelector('#length_8');
botonComprar50.addEventListener('click', function() {
    obtener_multiplesRango(url3, FiltroRangoGeneralPartiendodevehicles, "name", "length", 5, 8);
});

const botonComprar51 = document.querySelector('#length_9');
botonComprar51.addEventListener('click', function() {
    obtener_multiplesRango(url3, FiltroRangoGeneralPartiendodevehicles, "name", "length", 5, 9);
});
...
const botonComprar53 = document.querySelector('#length_15');
botonComprar53.addEventListener('click', function() {
    obtener_multiplesRango(url3, FiltroRangoGeneralPartiendodevehicles, "name", "length", 5, 15);
});
...
const botonComprar57 = document.querySelector('#crew_5');
botonComprar57.addEventListener('click', function() {
    obtener_multiplesRango(url3, FiltroRangoGeneralPartiendodevehicles, "name", "crew", 5, 5);
});
...
const botonComprar59 = document.querySelector('#crew_15');
botonComprar59.addEventListener('click', function() {
    obtener_multiplesRango(url3, FiltroRangoGeneralPartiendodevehicles, "name", "crew", 5, 15);
});
...
const botonComprar62 = document.querySelector('#passengers_5');
botonComprar62.addEventListener('click', function() {
    obtener_multiplesRango(url3, FiltroRangoGeneralPartiendodevehicles, "name", "passengers", 5, 5);
});
...
const botonComprar64 = document.querySelector('#passengers_30');
botonComprar64.addEventListener('click', function() {
    obtener_multiplesRango(url3, FiltroRangoGeneralPartiendodevehicles, "name", "passengers", 5, 30);
});
...
const botonComprar69 = document.querySelector('#diameter15000');
botonComprar69.addEventListener('click', function() {
    obtener_multiplesRango(url5, FiltroRangoGeneralPartiendodeplanetas, "name", "diameter", 8, 15000);
});
...
const botonComprar73 = document.querySelector('#orbital_period300');
botonComprar73.addEventListener('click', function() {
    obtener_multiplesRango(url5, FiltroRangoGeneralPartiendodeplanetas, "name", "orbital_period", 8, 300);
});
...
const botonComprar75 = document.querySelector('#orbital_period500');
botonComprar75.addEventListener('click', function() {
    obtener_multiplesRango(url5, FiltroRangoGeneralPartiendodeplanetas, "name", "orbiriodtal_period", 8, 500);
});
...
const botonComprar77 = document.querySelector('#population1000');
botonComprar77.addEventListener('click', function() {
    obtener_multiplesRango(url5, FiltroRangoGeneralPartiendodeplanetas, "name", "population", 8, 10000);
});
...
const botonComprar79 = document.querySelector('#population20000');
botonComprar79.addEventListener('click', function() {
    obtener_multiplesRango(url5, FiltroRangoGeneralPartiendodeplanetas, "name", "population", 8, 200000);
});
